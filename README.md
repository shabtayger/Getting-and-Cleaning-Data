...
[Explanation about the project](http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones)
...
The function tidifyActivityData(activityFilename=NULL, activitySummaryFilename=NULL) included in the [attached R script](), downloads the original data, and  returns a list with 3 elements:
...
The [codebook]() for the [activity summary file]() is attached as well.
